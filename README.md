...
| 평가·리뷰 | `skills/sast/sub-skills/scan-report-review/SKILL.md` | 3모드(`evaluate_phase1`/`evaluate`/`review`): Phase 1 품질 평가, Phase 2 증거 기반 status 할당, 보고서 정확성 검증 ([상세 가이드](docs/review-modes.md)) |
