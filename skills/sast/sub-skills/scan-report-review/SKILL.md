...
| 종류 | 검증 / 전체 |
|------|-----------|
| 후보/확인됨 | N / M_candidates (원래) → M_candidates_final (승격 +X, 폐기 −Y) |
| 공격 체인 | N / M_chains |
| 이상 없음 | N / M_safe |
...
M_candidates_final = M_candidates − 폐기로_제거된_수 + 승격된_수
(폐기_count + 유지_count + 불명확_count ≠ M_candidates_final이면 검증 미완료로 간주하여 결과 반환 거부)
